...
echo "DOMAIN_NAME=sasalama.42.fr" > project/srcs/.env
echo "CERT_=./srcs/requirements/tools/sasalama.42.fr.crt" >> project/srcs/.env
echo "KEY_=./srcs/requirements/tools/sasalama.42.fr.key" >> project/srcs/.env
